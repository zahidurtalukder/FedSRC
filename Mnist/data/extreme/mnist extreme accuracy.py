...
data1= 'clean Mnist extreme.pkl'
clean= open_file(data1)

data2= 'fedasl Mnist extreme.pkl'
fedasl= open_file(data2)

data3= 'fedavg Mnist extreme.pkl'
fedavg= open_file(data3)

data4='fedsrc Mnist extreme.pkl'
fedsrc= open_file(data4)

data5= 'krum Mnist extreme.pkl'
krum= open_file(data5)

data6='median Mnist extreme.pkl'
median= open_file(data6)

data7= 'tm Mnist extreme.pkl'
tm= open_file(data7)
...
plt.show
plt.savefig('../../figure/mnist extreme accuracy.png', bbox_inches='tight')
