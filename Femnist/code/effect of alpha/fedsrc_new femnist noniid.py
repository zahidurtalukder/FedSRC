...
for i in range(epochs):
    ...
    if i%10==0 and i>0:
        ...
        sample_list = [global_accuracy, global_loss, group1_train_accuracy, group1_train_loss, group1_accuracy, group1_loss, global_weight_list, bad_client_flip, bad_client_shuffle, bad_client_noise, taken_client,blocked_client]
        save_file_name= f'../../data/effect of alpha/fedsrc femnist noniid {alpha}.pkl'
