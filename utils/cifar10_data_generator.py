...
def create_non_iid_cifar10(x_train, y_train, num_client, percent,initial):
...
def cifar10_noniid_shuffle_data(client_percent, data_percent, num_clients):    # Get the data.
    ...
    dataset, client_names= create_non_iid_cifar10(x_train, y_train, num_clients, percent=.5,initial='shuffle_clients')
...
def cifar10_noniid_flip_data(client_percent, data_percent, num_clients):    # Get the data.
    (x_train, y_train), (x_test, y_test) = tf.keras.datasets.cifar10.load_data()
    x_train = x_train.astype('float32')
    x_test = x_test.astype('float32')
    x_train /= 255
    ...
    nb_classes = 10
    y_test = tf.keras.utils.to_categorical(y_test, nb_classes)
    dataset, client_names = create_non_iid_cifar10(x_train, y_train, num_clients, percent=.5, initial='flip_clients')
...
def cifar10_noniid_noise_data(client_percent, data_percent, num_clients):    # Get the data.
    (x_train, y_train), (x_test, y_test) = tf.keras.datasets.cifar10.load_data()
    x_train = x_train.astype('float32')
    x_test = x_test.astype('float32')
    x_train /= 255
    ...
    nb_classes = 10
    y_test = tf.keras.utils.to_categorical(y_test, nb_classes)
    dataset, client_names= create_non_iid_cifar10(x_train, y_train, num_clients, percent=.5,initial='noisy_clients')
...
def create_non_iid_extreme_cifar10(x_train, y_train, num_client, percent,initial):
    # Define the number of shards and clients
...
def cifar10_noniid_extreme_shuffle_data(client_percent, data_percent, num_clients):    # Get the data.
    ...
    nb_classes = 10
    y_test = tf.keras.utils.to_categorical(y_test, nb_classes)
    dataset, client_names= create_non_iid_extreme_cifar10(x_train, y_train, num_clients, percent=.5,initial='shuffle_clients')
...
def cifar10_noniid_extreme_flip_data(client_percent, data_percent, num_clients):    # Get the data.
    ...
    nb_classes = 10
    y_test = tf.keras.utils.to_categorical(y_test, nb_classes)
    dataset, client_names = create_non_iid_extreme_cifar10(x_train, y_train, num_clients, percent=.5, initial='flip_clients')
...
def cifar10_noniid_extreme_noise_data(client_percent, data_percent, num_clients):    # Get the data.
    ...
    nb_classes = 10
    y_test = tf.keras.utils.to_categorical(y_test, nb_classes)
    dataset, client_names= create_non_iid_extreme_cifar10(x_train, y_train, num_clients, percent=.5,initial='noisy_clients')
