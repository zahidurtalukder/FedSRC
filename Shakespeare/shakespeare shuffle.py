...
for i in range(epochs):
    ...
    if len(model1_train_accuracy)>0:
        ...
        global_median, global_standard_dev= np.mean(group1_loss[-1]), np.std(group1_loss[-1])
        print(f'median is {global_median} and Standard deviation {global_standard_dev}')
    ...
    if i%10==0 and i>0:
        ...
        save_file_name= f'../data/fedavg shakespeare shuffle {alpha}.pkl'
