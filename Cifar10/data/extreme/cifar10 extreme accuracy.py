...
data1= 'clean cifar10 extreme.pkl'
clean= open_file(data1)

data2= 'fedasl cifar10 extreme.pkl'
fedasl= open_file(data2)

data3= 'fedavg cifar10 extreme.pkl'
fedavg= open_file(data3)

data4='fedsrc cifar10 extreme.pkl'
fedsrc= open_file(data4)

data5= 'krum cifar10 extreme.pkl'
krum= open_file(data5)

data6='median cifar10 extreme.pkl'
median= open_file(data6)

data7= 'tm cifar10 extreme.pkl'
tm= open_file(data7)
...
# plt.yticks(np.arange(25, 101, 15))
# plt.ylim(25, 100)
plt.xlim(0, 300)
...
plt.show
plt.savefig('../../figure/cifar10 extreme accuracy.png', bbox_inches='tight')
