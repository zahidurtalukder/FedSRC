...
data1= 'clean cifar10 noniid.pkl'
clean= open_file(data1)

data2= 'fedasl cifar10 noniid.pkl'
fedasl= open_file(data2)

data3= 'fedavg cifar10 noniid.pkl'
fedavg= open_file(data3)

data4='fedsrc cifar10 noniid.pkl'
fedsrc= open_file(data4)

data5= 'krum cifar10 noniid.pkl'
krum= open_file(data5)

data6='median cifar10 noniid.pkl'
median= open_file(data6)

data7= 'tm cifar10 noniid.pkl'
tm= open_file(data7)
...
plt.show
plt.savefig('../../figure/cifar10 noniid accuracy.png', bbox_inches='tight')
