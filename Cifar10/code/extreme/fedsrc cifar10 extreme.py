...
for i in range(epochs):
    ...
    if i < 2:
        ...
        if statistics.stdev(model1_train_loss) * beta > cut:
            ...
            cutoff = statistics.median(model1_train_loss) + cut
            print(f'cutoff is {cutoff} in epocchs {i}')
    print(f'median {statistics.median(model1_train_loss)}')
    print(f'STD {statistics.stdev(model1_train_loss)}')
    ...
    if i%10==0 and i>0:
        ...
        save_file_name= f'../../data/extreme/fedsrc newest cifar10 extreme.pkl'
