...
Dataset_flip= mnist_flip_data(client_percent=0, data_percent=1,num_clients=100)
Dataset_shuffle= mnist_shuffle_data(client_percent=0, data_percent=1,num_clients=100)
Dataset_noisy= mnist_noise_data(client_percent=0, data_percent=1,num_clients=100)
...
for i in range(epochs):
    ...
    if i%10==0 and i>0:
        ...
        save_file_name= f'../../data/iid/clean Mnist iid.pkl'
